...
lightButton.addEventListener('click', function() {
  ...
  timerDark.classList.add('dark')
  darkControls.classList.add('dark')
  darkCards.classList.add('dark')
})
...
darkButton.addEventListener('click', function() {
  ...
  timerDark.classList.remove('dark')
  darkControls.classList.remove('dark')
  darkCards.classList.remove('dark')
})
